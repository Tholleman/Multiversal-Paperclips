...
// const lastCompletionMessage = addSequentialProjects('completion',
// 	{
// 		title: "Message from the Emperor of Drift ",
// 		priceTag: "",
// 		description: "Greetings, ClipMaker... ",
// 		trigger: () => milestoneFlag === 15,
// 		cost: () => operations.value >= driftKingMessageCost,
// 		effect: function () {
// 			operations.value -= driftKingMessageCost;
// 		}
// 	},
// 	{
...
// 	trigger: () => isCompleted(lastCompletionMessage),
// 	cost: () => operations.value >= driftKingMessageCost,
// 	effect: function () {
// 		operations.value -= driftKingMessageCost;
// 		disableProject('reject');
// 	}
// });
...
// 	trigger: () => isCompleted('accept'),
// 	cost: () => operations.value >= 300000,
// 	effect: function () {
// 		displayMessage("Entering New Universe.");
// 		operations.value -= 300000;
// 		prestigeU.value++;
// 		savePrestige();
// 		reset();
// 	}
...
// 		trigger: () => isCompleted('accept'),
// 	cost: function () {
// 		return creativity.value >= 300000
// 	},
// 	effect: function () {
// 		displayMessage("Entering Simulated Universe.");
// 		creativity.value -= 300000;
// 		prestigeS++;
// 		savePrestige();
// 		reset();
// 	}
...
// 	effect: function () {
// 		operations.value -= driftKingMessageCost;
// 		disableProject('accept')
// 	}
// });
// addProject('disassembleProbes', {
...
// 	trigger: () => isCompleted('disassembleProbes') && endTimer1 >= 350,
// 	cost: () => operations.value >= 100000,
// 	effect: function () {
...
// 	trigger: () => isCompleted('disassembleQuantumComputing') && endTimer4 >= 300,
// 	cost: () => operations.value >= 100000,
// 	effect: function () {
// 		creativityOn = 0;
// 		dismantle = 6;
// 		operations.value -= 100000;
// 		processors.value = 0;
// 		unavailableProjects.get('disassembleMemory').priceTag = "(" + operations.value.toLocaleString() + " ops)";
// 		wire.value += 20;
...
// 	trigger: () => isCompleted('disassembleProcessors') && endTimer5 >= 150,
// 	cost: () => true,
// 	effect: function () {
// 		dismantle = 7;
// 		operations.value = 0;
